...
Recup_Threshold = 0.06

Catalog_overfit = 20

subs = len(t_values)//(Catalog_overfit*len(Catalog))
...
q_d_v = np.gradient(thetas_values_n[::subs,0], t_values_s)
print("Deviation gradient",np.linalg.norm(q_d_v - thetas_values[::subs,1])) #tres important
